...
- Trained at: 2026-09-26T21:25:31.532074+05:30
- ML start year: 2018
- Latest completed race included by model: `2026-14`
- Latest completed race currently available in API: `2026-14`
- Raw training rows: 3766
- Feature rows: 3766
- Feature count: 42
...
- Latest API result: 2026-14 | Spanish Grand Prix | api_results_available | scheduled 2026-09-13T18:30:00+05:30
- Waiting for delay: 2026-15 | Azerbaijan Grand Prix | waiting_final_results_delay | scheduled 2026-09-26T16:30:00+05:30
- Past cutoff but API still missing results: -
- Next race: 2026-16 | Bahrain Grand Prix in Malaysia | - | scheduled 2026-10-04T12:30:00+05:30
...
| win | AUC | 0.859 |
| win | Brier | 0.042 |
| win | Validation rows | 563 |
| podium | AUC | 0.951 |
| podium | Brier | 0.060 |
| podium | Validation rows | 563 |
| top10 | AUC | 0.827 |
| top10 | Brier | 0.167 |
| top10 | Validation rows | 563 |
| finish_position | MAE | 3.279 |
| finish_position | RMSE | 4.123 |
| finish_position | Validation rows | 563 |
| ranking | winner_hit | 57.1% |
| ranking | top3_recall | 67.9% |
| ranking | top5_recall | 78.6% |
| ranking | top10_recall | 77.5% |
| ranking | exact_position_accuracy | 8.3% |
| ranking | mean_position_error | 3.264 |
| neural_lap_time_forecast | MAE seconds | 3.601 |
| neural_lap_time_forecast | RMSE seconds | 5.047 |
